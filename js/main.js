...
$('#yes').click(function() {
    ...
    audio.play();
    Swal.fire({
        title: CONFIG.mess, // Display the message directly
        text: CONFIG.messDesc, // Optional detailed message
        width: 900,
        padding: '3em',
        background: '#fff url("img/iput-bg.jpg")',
        backdrop: `
        ...
        window.location = CONFIG.messLink; // Redirect after confirmation
                }
            })
        }
    })
